...
export function VerseGame() {
  ...
  const checkWord = () => {
    if (answer.trim().toLocaleLowerCase() === "fortalece") { setMessage("¡Muy bien! Esa palabra completa el versículo."); setStep(2); }
