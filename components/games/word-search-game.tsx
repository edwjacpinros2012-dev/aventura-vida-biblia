...
const boards = [
  ["AMORQZKLPV", "FENUBESDAR", "LUZCAMINOS", "PAZSEMILLAS", "DAVIDRUTAS", "NOEESPERAN", "VIDAESTRELL", "REYAMIGOSX", "ORACIONFEY", "SERVICIOLU"],
  ["AMORLUCESX", "FESENDEROS", "LUZAMIGOSX", "PAZJARDINX", "DAVIDNUBES", "NOEESPERAN", "VIDAESTRELL", "REYAMIGOSX", "ORACIONFEY", "SERVICIOLU"],
];
const levels = {
...
export function WordSearchGame() {
  ...
  const letters = useMemo(() => boards[variant].join("").split(""), [variant]);
  ...
  const reset = (nextDifficulty = difficulty, nextVariant = variant) => {
    setDifficulty(nextDifficulty); setVariant(nextVariant); setSeconds(nextDifficulty === "Inicial" ? 180 : 240); setSelected([]); setFound([]); setScore(0); setMessage("Toca las letras en orden para formar una palabra."); resetCompletion();
  };
