...
export function BibleMazeGame() {
  ...
  const completeLevel = useCallback(() => {
    ...
    finish(level.reward);
  }, [finish, level.layouts.length, level.reward, levelNumber, moves, result, routeVersion, saveGameProgress, unlockedLevel]);
  ...
  }, [completeLevel, layout, result, screen, tokenKeys.length]);
