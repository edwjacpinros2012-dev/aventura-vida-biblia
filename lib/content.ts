...
export const games: Game[] = [
  ...
  {
    id: "bible-maze",
    slug: "laberinto-biblico",
    name: "Laberinto Bíblico",
    tagline: "Encuentra el camino que ilumina la aventura",
    description: "Recorre siete laberintos, reúne destellos y abre nuevas rutas.",
    longDescription: "Una aventura original de siete niveles inspirados en grandes caminos bíblicos. Usa teclado o controles táctiles para explorar rutas variables, reunir destellos y desbloquear el siguiente laberinto.",
    category: "Aventuras",
    difficulty: "Aventurero",
    ...
    isPlayable: true,
    gameKey: "bible-maze",
    lesson: "Cada paso de fe, amor y esperanza puede iluminar un camino nuevo.",
    objectives: ["Elige un nivel del mapa", "Reúne todos los destellos", "Llega a la salida para desbloquear la siguiente ruta"],
  },
  {
